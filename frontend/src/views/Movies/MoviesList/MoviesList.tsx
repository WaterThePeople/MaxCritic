...
import style from "./MoviesList.module.sass";
import View from "wrappers/View/View";
import DefaultButton from "components/DefaultButton/DefaultButton";
import Modal from "components/Modal/Modal";
import MoviesFilters from "./Features/MoviesFilters/MoviesFilters";
import MoviesOrders from "./Features/MoviesOrders/MoviesOrders";
import MoviesListView from "./Features/MoviesListView/MoviesListView";
      ...
      <div className={style.content}>
        ...
        <div className={style.container}>
          ...
          <div className={style.column}>
            ...
            <MoviesListView data={data} loading={loading} pageSize={pageSize} />
            {!loading && (
              <Pagination
                amount={dataCount}
                currentPage={page}
