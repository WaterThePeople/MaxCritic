...
from ...music.serializers.reviews import ProfileSongReviewSerializer
...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    song_reviews = ProfileSongReviewSerializer(many=True, read_only=True)
    image = 'image_as_base64'

    class Meta:
        model = CustomUser
        fields = ['username',
                  'image', 'game_reviews', 'movie_reviews', 'show_reviews', 'song_reviews']
