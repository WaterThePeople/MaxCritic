...
import style from "./SongsList.module.sass";
import View from "wrappers/View/View";
import DefaultButton from "components/DefaultButton/DefaultButton";
import Modal from "components/Modal/Modal";
import SongsFilters from "./Features/SongsFilters/SongsFilters";
import SongsOrders from "./Features/SongsOrders/SongsOrders";
import SongsListView from "./Features/SongsListView/SongsListView";
  ...
  const getSongsData = async () => {
    ...
    try {
      const response = await axios.get(
        `${serverPath}api/songs/list?${query.toString()}&page_size=${pageSize}`,
        {
          headers: accessToken
  ...
  return (
    <View background="purple">
      <div className={style.content}>
        <div className={style.title}>List of Songs</div>
        ...
        <div className={style.container}>
          ...
          <div className={style.column}>
            ...
            <SongsListView data={data} loading={loading} pageSize={pageSize} />
            {!loading && (
              <Pagination
                amount={dataCount}
                currentPage={page}
