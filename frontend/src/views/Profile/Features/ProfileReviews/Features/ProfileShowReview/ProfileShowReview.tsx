...
import style from "./ProfileShowReview.module.sass";
    ...
    <div className={style.item}>
      <div className={style.row}>
        <div className={style.column}>
          ...
          <DefaultLink className={style.name} to={`/shows/${item?.show_slug}`}>
            {item?.show_name}
          </DefaultLink>
...
export default ProfileShowReview;
